...
public class PanelDetallesRestaurante extends JPanel
{
    ...
    public PanelDetallesRestaurante( )
    {
        ...
        // TODO completar el constructor
    	JLabel labCalificacion= new JLabel();
        // Configura el checkbox para indicar si ya se visitaó o no el restaurante
        // TODO completar el constructor
    	JCheckBox chkVisitado= new JCheckBox();
    	chkVisitado.setName("Visitado");
    ...
    private void actualizarRestaurante( String nombre, int calificacion, boolean visitado )
    {
     // TODO completar actualizarRestaurante
    	this.labNombre.setText(nombre);
    	this.labCalificacion.setText(String.valueOf(calificacion));
